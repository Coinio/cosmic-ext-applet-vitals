...
settings-label-colour = Label/Icon Colour
settings-network-rx-colour = Download Icon Colour
settings-network-tx-colour = Upload Icon Colour
settings-disk-read-colour = Read Icon Colour
settings-disk-write-colour = Write Icon Colour
