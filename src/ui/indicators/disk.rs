...
use crate::ui::indicators_ui::IndicatorsUI;
...
impl DiskStats {
    pub fn draw<'app>(&self, app_state: &'app AppState, horizontal: bool) -> Option<Element<'app, Message>> {
        ...
        let font_size = IndicatorsUI::calculate_font_size(app_state);
        ...
        let read_value = indicator_value(
            core,
            IndicatorValueProps {
        ...
        let write_value = indicator_value(
            core,
            IndicatorValueProps {
